...
const SeparationModal: React.FC<SeparationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="modal-light bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="date"
                  required
                  value={typeof formData.fechaSeparacion === 'string' ? formData.fechaSeparacion : new Date(formData.fechaSeparacion).toISOString().split('T')[0]}
