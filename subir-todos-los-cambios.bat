...
git add backend/src/controllers/marketplace.controller.ts
...
git commit -m "feat: Implementa gastos dinamicos de inversionistas y marketplace publico

- Agrega sistema de gastos dinamicos por inversionista en VehicleForm
- Implementa marketplace publico sin autenticacion
- Actualiza modelo Vehicle con gastos detallados
- Agrega controlador marketplace para vehiculos listos_venta
- Actualiza rutas y controladores de vehiculos"
...
echo.
echo 3. VERIFICAR:
echo    - Prueba el marketplace: https://[tu-dominio-vercel]/marketplace
echo    - Prueba crear/editar vehiculo con gastos
echo.
echo ========================================
pause
